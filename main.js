...
var spanName = document.querySelector('#span-nome');
var spanPartido = document.querySelector('#span-partido');
var imgPrincipal = document.querySelector('#img-prefeito');
var imgVicePrefeito = document.querySelector('#img-vice-prefeito');
var votos = [];
var etapa = 1;
var branco = false;
var nulo = false;
